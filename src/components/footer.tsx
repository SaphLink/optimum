...
export const FooterIcon = ({ children }: any) => {
  return (
    <div className="cursor-pointer h-[50px] w-[50px] rounded-[50%] border-[3px] border-white flex items-center justify-center">
      {children}
    </div>
  );
};
...
const Footer = () => (
  <div className=" bg-[#35281e]">
    <FooterContainer className="container">
      <FooterLeft className="!items-start mb-[2rem] md:mb-[0]">
        <Logo
          src="/images/homepage/Optimum Laser Brown White.png"
          alt="White Logo"
        />
        {/* <Description className='text-center md:text-left' >1180 Northern Blvd, Suite 201, Manhasset, NY 11030</Description> */}
        <p className="text-center md:text-left font-medium text-xl font-[Raleway]">
          1180 Northern Blvd, Suite 202, Manhasset, NY 11030
        </p>
        <SocialIcons>
          ...
          <a
            href="https://www.instagram.com/optimum.laser/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA=="
            target="_blank"
          >
            <FooterIcon>
      ...
      <FooterRight>
        <Section>
          ...
          <ul>
            ...
            <li>
              {" "}
              <a href={"/services/laser-service"}>Laser Hair Removal</a>
            </li>
            <li>
              {" "}
              <a href={"/services/pigmentation-service"}>
                Pigmentation Removal
              </a>
            </li>
            <li>
              {" "}
              <a href={"/services/vein-removal"}>Vein Removal</a>
            </li>
            <li>
              {" "}
              <a href={"/services/facial-service"}>Facial Services</a>
            </li>
            <li>
              {" "}
