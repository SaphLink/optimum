    ...
    <>
      ...
      <div className="px-5 bg-[#35281e] p-[2rem] mt-[40px]">
        <div className="px-[20px] md:px-[200px]">
          ...
          <br/>
          <p className="text-white font-semibold text-[1.3rem] md:text-[1.1rem] font-[Raleway] text-center md:text-left leading-relaxed">
            At Optimum Laser NY in Manhasset NY, we use state-of-the-art technology in addition to our <span style={{ fontWeight: '800' }}>15-year expertise with hair removal</span> to provide maximum results to achieve your goal of being hair-free.
          </p>
          <br/>
          <p className="text-white font-semibold text-[1.3rem] md:text-[1.1rem] font-[Raleway] text-center md:text-left leading-relaxed">
            <span style={{ fontWeight: '800' }}>Contact us</span> for more information on how you can <span style={{ fontWeight: '800' }}>start electrolysis today!</span>
          </p>
        </div>
      </div>
      ...
      <FlowerSection>
        <div style={{ fontSize: '1.7rem', lineHeight: '1.4' }} className="mobile-text-optimized">
          At <strong>Optimum Laser NY</strong>, we take pride in delivering <strong>safe, consistent, and effective results for women and men of all skin types</strong>. We understand how difficult it can be to find the right laser and beauty spa — that's why our team is committed to providing <strong>affordable treatments using advanced laser technology tailored to your unique needs</strong>.
        </div>
        <br />
        <br />
        <div style={{ fontSize: '1.6rem', lineHeight: '1.4' }} className="mobile-text-optimized">
          Some of our most <strong>popular laser hair removal areas</strong> for both men and women include:
          <br className="block md:hidden" />
          <div style={{ marginTop: '0.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }} className="bullet-list-container mobile-centered">
            <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '0.3rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '0.3rem' }}>
              <span style={{ marginRight: '0.3rem' }}>•</span>
              <span>Upper Lip (<strong>Full Face</strong>)</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '0.3rem' }}>
              <span style={{ marginRight: '0.3rem' }}>•</span>
              <span>Back</span>
        ...
        <br />
        <div style={{ fontSize: '1.6rem', lineHeight: '1.4' }} className="mobile-text-optimized">
          Sessions are <strong>fast and convenient</strong> — most treatments range from <strong>just 5 minutes to an hour</strong>, depending on the area. Say a final <strong>goodbye to razors, waxing, and ingrown hairs</strong> — and say <strong>hello to smooth, flawless skin that lasts</strong>.
        </div>
      </FlowerSection>
      <div
