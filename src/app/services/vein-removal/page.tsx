...
<Helmet>
      ...
      <div className="relative h-[700px] mt-[9.4rem] md:mt-[10.8rem] sm:mt-[10.5rem] lg:mt-[10.5rem] container mx-auto bg-gradient-to-r from-[#faecdb] to-[#f9efdd] flex items-baseline md:items-center justify-center">
        <div className="grid md:grid-cols-2 sm:grid-cols-2 place-items-center">
          <div className="md:py-10 py-0 z-10">
            <Box>
              <div className="text-[3rem] md:text-[4rem] text-white text-center md:text-left">VEIN</div>
              <div className="text-[1.8rem] md:text-[2.5rem] text-white text-center md:text-left">REMOVAL</div>
              <div className="line"></div>
              <div className="desc" style={{ fontSize: '1.3rem', lineHeight: '1.4' }}>
                <strong>Say <strong>goodbye to visible spider veins</strong> with <strong>non-invasive laser vein removal at Optimum Laser NY in Manhasset Long Island</strong>. Using advanced <strong>Cynosure Apogee Elite+™</strong> technology, we <strong>target and reduce the appearance of unwanted veins—safely, quickly, and with little to no downtime</strong>.</strong>
              </div>
              <CustomButton className="inline-block" href="#consultation" type="primary">BOOK A FREE CONSULTATION</CustomButton>
            </Box>
          </div>
      ...
      <FlowerSection showMap={true} hideSmallLeaf={true}>
        ...
        <div style={{ fontSize: '1.4rem', lineHeight: '1.4' }} className="consultation-text">
          <strong>Book a free consultation</strong> with us to assess if you are a <strong>good candidate</strong> for vein removal treatment.
        </div>
      </FlowerSection>
      ...
      <div className="relative h-auto md:min-h-[900px] container mx-auto bg-gradient-to-r from-[#faecdb] to-[#f9efdd] flex items-baseline md:items-center justify-center]">
        <div className="grid md:grid-cols-2 sm:grid-cols-2 place-items-center items-start md:items-center">
          <div>
          ...
          <div className="md:py-10 py-0 z-10">
            <Box>
              ...
              <div className="line"></div>
              <div className="desc" style={{ fontSize: '1.3rem', lineHeight: '1.4' }}>
                <strong>The <strong>Cynosure</strong> laser delivers pulses of light energy that heat and <strong>collapse the walls of the targeted veins</strong>. These veins are then naturally reabsorbed by the body over time and disappear, <strong>leaving your skin looking clearer and more even</strong>. This treatment is <strong>precise</strong> and <strong>gentle</strong>, affecting only the <strong>targeted veins without harming the surrounding skin</strong>—making it ideal for areas like the <strong>legs, face, and ankles</strong>.</strong>
              </div>

              <div className="title text-center md:text-left mt-[2rem]" style={{ fontSize: '1.5rem', lineHeight: '1.2' }}>WHAT TO EXPECT DURING YOUR</div>
              <div className="mini-title text-center md:text-left">SPIDER VEIN REMOVAL SESSION!</div>
              <div className="line"></div>
              <div className="desc text-left" style={{ fontSize: '1.3rem', lineHeight: '1.4' }}>
                <strong>
                                     <ul className="list-disc pl-6 space-y-3 md:space-y-2">
                    <li>A consultation to assess your veins and skin type</li>
                    <li>Treatment sessions last 15–30 minutes, depending on the area</li>
                    <li>Mild redness or warmth may occur and typically fades within a few hours</li>
                    <li>No incisions, no downtime — you can resume normal activities right after</li>
                    <li>Most clients see noticeable improvement in 1 to 3 sessions, spaced about 4–6 weeks apart</li>
                    <li>The number of treatments depends on the size, depth, and color of the veins, as well as individual response to treatment</li>
                  </ul>
                </strong>
              </div>
              <div className="mt-[0.75rem]"></div>
              <div className="desc font-bold text-center" style={{ fontSize: '1.7rem', lineHeight: '1.4', fontWeight: 800 }}>
                <strong>Book your free consultation with us to see how we best can help you!</strong>
              </div>
