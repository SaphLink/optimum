...
const page = () => {
    return (
        <div className="pt-[1rem]">
            ...
            <Section>
                <div className={'justify-center items-stretch min-h-[400px] flex flex-wrap p-[2rem]'}>
                    <div className={'flex-1 p-[2rem] '}>
                        <div className={'mb-[3rem]'} style={{
                            fontFamily: 'Raleway, sans-serif',
                            fontSize: '1.2rem',
                            fontWeight: 200,
                        }}>
                            <div className={'mb-[3rem]'}>
                                Located in Manhasset, New York, the highly experienced <span
                                style={{
                                    fontFamily: "Broadway",
                                    fontSize: "1.3rem",
                                  }}
                  ...
                  Optimum Laser Hair Removal
                </span>{" "} team emphasizes effective and immediate results all while ensuring the highest
                                level of professionalism, cleanliness, and patient satisfaction.
                            </div>
                            <div className={'mb-[3rem]'}>
                            <span
                                style={{
                            ...
                            >
                   Optimum Laser Hair Removal
                </span>{" "} offers face and body treatments including laser hair removal, laser vein
                                removal, pigmentation treatment, skin rejuvenation, anti-aging facials, and acne
                                treatment.
                                All treatments are executed to ensure maximum results in minimal time. Our team uses
                                state-of-the-art FDA approved technology, such as the Cynosure Apogee Elite+ TM laser
                            </div>
                            <div className={'mb-[3rem]'}>
                                Since 2009, the entire <span
                                style={{
                                    fontFamily: "Broadway",
                                    fontSize: "1.3rem",
                                  }}
                            >
                   Optimum Laser Hair Removal
                </span>{" "}team has been dedicated to helping patients receive the utmost results in the
                                shortest time frames possible. Regardless of each patient's aesthetic goals, our caring
                                and
                                detail-oriented team will leverage a flexible approach to achieve the customer's
                                desires.
                                The team is ready to help men and women of all skin types, located in Manhasset and
                                surrounding areas, look and feel fantastic.
                            </div>
                            Book an appointment online or call the office at 516-495-4908 to schedule a <span
                            style={{
...
FREE CONSULTATION                </span>{" "} today!
                    ...
                    <div className={'w-[40%] p-[2rem] flex justify-center items-start'}>
                        <div
                            className={'w-full max-w-[500px] h-[40rem] min-w-[450px] rounded-[2rem]'}>
                            <img className={'w-full h-full object-cover rounded-[2rem]'} src={'../images/cropped-images/Optimum Laser Office Cropped.png'} />
                        </div>
                    </div>
                </div>
            </Section>
            <Section bg2>
                <div className={'pt-[3rem]'}>
                    ...
                    <SectionDescription> Take a look at some of our treatments we provide to our valued
                        customers</SectionDescription>
