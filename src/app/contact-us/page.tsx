  ...
  return (
    <>
      <Section hero id='consultation'>
        ...
        <SectionDescription>
          The Optimum Laser Hair Removal Team is available for all your questions, concerns and scheduling. Please contact us at your earliest
          convenience during our business hours! We will get back to you as soon as possible.
        </SectionDescription>
        <form action={`https://formsubmit.co/${process.env.NEXT_PUBLIC_EMAIL}`} method="POST">
          <div className="w-full mb-[4rem] flex flex-col gap-[1rem] justify-center items-center">
            ...
            <textarea name="message" placeholder="Message" className={"placeholder-black px-[2rem] py-[1rem] "} style={textareaStyle}></textarea>
          </div>
      ...
      <BoxSection>
        <BoxSplitSection>
          <Box>
            ...
            <CustomButton href='/about-us' type="primary">LEARN MORE</CustomButton>
          </Box>
        </BoxSplitSection>
        <Img src="../images/cropped-images/Homepage Group 1 Cropped.png" alt="image" />
        <CustomCircle
          labels={[
      ...
      <Section last>
        ...
        <Slider>
          <ReviewCard img="images/testimonials/debbie-y.png" name="debbie y" time="6 months ago">
            Optimum Laser is a professional pleasant company. I have started treatments more than 10 years ago and now my doughters enjoy the warm and welcoming service that we get there. Never a problem, always welcoming and accommodating and clean !  Thank you for making us smooth and happy :)
          </ReviewCard>
          <ReviewCard img="images/testimonials/zareen.png" name="Zareen Mistry" time="2 months ago">
            Daniela is amazing! I have had the best experience and even better results. Very clean, very professional from the front desk to the technician. Always v accommodating also. The best place I've been to for laser hair removal, and hopefully the last bc the results are excellent so far!!
          </ReviewCard>
          <ReviewCard img="images/testimonials/urfa.png" name="Urfa Ajmal" time="5 months ago">
            I have been getting laser hair removals and electrolysis for my face for months. This place is the best! I get my laser from Daniela and she is the best, I have seen my hair growth lessen so much and I an loving it. Definitely go to them! They are the best
          </ReviewCard>
          ...
          <ReviewCard img="images/testimonials/justin.png" name="Justin Gomez" time="1 year ago">
            Optimum Laser is great - Eti is very helpful and makes scheduling appointments stress-free. Daniela is an awesome tech - not only is she great at what she does, but she also has a fun personality that makes you feel comfortable. I’ve seen greatly noticeable results so far, and look forward to seeing what future sessions will do for me!
          </ReviewCard>
          ...
          <ReviewCard img="images/testimonials/Mimmi.png" name="Mimmi Lindblad" time="2 years ago">
            ...
            Each experience has been great at Optimum Laser. Very professional & Nicole does a fantastic job, she makes you feel super comfortable and explain each part of the process as it happens. The place is very clean and the atmosphere is very pleasant. I highly recommend anyone who wants results and good service to come here!!
          </ReviewCard>
          ...
          <ReviewCard img="images/testimonials/kim.png" name="Kim Lazar" time="3 years ago">
            I got amazing results for my laser hair removal. The prices are reasonable, the owner is the nicest person, and no matter who I get one I come for a treatment, they all do a great job. Honestly, laser hair removal at optimum laser is some of the best money I’ve ever spent. I highly recommend!
          </ReviewCard>
        </Slider>
